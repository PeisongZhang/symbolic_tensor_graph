...
def _resolve_gqa_kernel_path(tpsp=True, attention_backend=None, flash_attention=False):
    backend = attention_backend
    if backend is None:
        backend = "flash" if flash_attention else "fused"
    if tpsp:
        kernel_paths = {
            "standard": "./sharding_spreadsheets/module3/tpsp_gpt/group_query_attention_kernel.csv",
            "fused": "./sharding_spreadsheets/module3/tpsp_gpt/group_query_attention_kernel_fused.csv",
            "flash": "./sharding_spreadsheets/module3/tpsp_gpt/group_query_attention_kernel_flash.csv",
        }
    else:
        kernel_paths = {
            "standard": "./sharding_spreadsheets/module3/tp_gpt/group_query_attention_kernel.csv",
            "fused": "./sharding_spreadsheets/module3/tp_gpt/group_query_attention_kernel_fused.csv",
            "flash": "./sharding_spreadsheets/module3/tp_gpt/group_query_attention_kernel_flash.csv",
        }
...
def gpt(
    ...
    cache_filename = os.path.join(CACHE_DIR, f"gpt_{num_layers}_{tpsp}_attn_{backend}.csv")
